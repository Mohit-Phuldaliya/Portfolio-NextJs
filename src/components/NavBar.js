...
export default function NavBar() {
  ...
  return (
    <header className="w-full px-32 py-8  font-medium flex items-center justify-between dark:text-light relative z-[1] lg:px-16 md:px-12 sm:px-8">
      <button
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="https://github.com/Mohit-Phuldaliya"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.6 }}
            className="w-8 mx-3"
          ...
          <motion.a
            href="https://leetcode.com/include_mohit/"
            target={"_blank"}
            whileHover={{ y: -2 }}
            className="w-7 ml-3"
            whileTap={{ scale: 0.6 }}
      ...
      {isOpen ? (
        <motion.div
          ...
          className="min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 bg-dark/90 dark:bg-light/75 ro unded-lg backdrop-blur-md py-32"
        >
