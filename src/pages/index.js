          ...
          <div className="flex items-center justify-between w-full">
            <div className="w-1/2 flex items-center justify-center">
              <Image
                ...
                className="w-[30rem] h-auto rounded-full border-solid border-[5px] bg-dark/30 border-dark dark:bg-light dark:border-light"
                priority
            ...
            <div className="w-1/2 flex flex-col items-center justify-center self-center">
              ...
              <div className="flex items-center self-start mt-2">
                <Link
                  ...
                  className="flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-light hover:text-dark border-2  border-solid border-transparent hover:border-dark dark:border-light"
                >
                ...
                <Link
                  ...
                  className="flex items-center bg-light text-dark p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-dark hover:text-light border-2  border-solid border-dark hover:border-transparent ml-4 dark:border-light"
                >
