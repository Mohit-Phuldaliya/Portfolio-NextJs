      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        ...
        <div className=" w-full mt-2 flex items-center justify-between">
          <Link
            href={link}
            target="_blank"
            className=" rounded-lg bg-dark text-light p-1 px-6 text-lg font-semibold hover:bg-light hover:text-dark border border-solid border-2xl border-dark dark:border-light"
          >
            Visit
          </Link>
